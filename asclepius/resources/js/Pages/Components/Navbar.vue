...
<template>
    <header>
        <Popover class="relative bg-navbar mb-6">
            <div class="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
                ...
                <PopoverGroup as="nav" class="hidden md:flex space-x-10">
                    <Popover class="relative" v-slot="{ open }">
                        <PopoverButton :class="[open ? 'text-gray-900' : 'text-gray-800', 'group rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none']">
                            <span>Solutions</span>
                            <ChevronDownIcon :class="[open ? 'text-gray-800' : 'text-gray-800', 'ml-2 h-5 w-5 group-hover:text-gray-500']" aria-hidden="true" />
                        </PopoverButton>
                        ...
                        <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in duration-150" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-1">
                            <PopoverPanel class="absolute z-10 -ml-4 mt-3 transform w-screen max-w-md lg:max-w-2xl lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                                <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                    <div class="relative grid gap-6 px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2 bg-white">
                                        <a v-for="(item, index) in solutions" :key="item.name" :href="item.href" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                    ...
                    <a href="#" class="text-base font-medium text-gray-800 hover:text-gray-900"> Learn More </a>
                ...
                <PopoverPanel focus class="absolute z-30 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                    <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                        <div class="pt-5 pb-6 px-5">
                            ...
                            <div class="mt-6">
                                <nav class="grid grid-cols-1 gap-7 bg-white">
                        ...
                        <div class="py-6 px-5">
                            <div class="grid grid-cols-2 gap-4">
                                <a href="#" class="text-base font-medium text-gray-900 hover:text-gray-700"> Learn More </a>
                                <a href="/our-team" class="text-base font-medium text-gray-900 hover:text-gray-700"> Our Team </a>
                                <a href="/your-story" class="text-base font-medium text-gray-900 hover:text-gray-700"> Your Story </a>
                            </div>
                            <div class="mt-6">
